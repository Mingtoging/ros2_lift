            ...
            if len(msg.marker_ids) == 0:    # no marker found
                ...
                for i in range(len(msg.marker_ids)):
                    ...
                    if msg.marker_ids[i] == TARGET_ID:  # target marker found
                        ...
                        if self.get_ref_value == False:		#	중복 프린트문 나오지않게 하기위해
                                    ...
                                    if self.second_rotate_end == False:
                                        ...
                                        if self.align_finished == False:
                                            ...
                                            if self.approach_marker_end == False:
                                                ...
                                                self.tb3.rotate(R * 2)
                                                self.tb3.straight(-0.2)
                                                self.lift.data = "life_down"
                                                self.tb3.straight(-0.2)
...
if __name__ == '__main__':
    ...
    '''
    #OpenCR로 연결하려고 했더니 그 오돔 코드도 길고 어려워서 시리얼 통신을 통하여 
    #topic섭스크라이브 와일 루프 빠져나오는게 어려웠다 spin 원스 사용법 
